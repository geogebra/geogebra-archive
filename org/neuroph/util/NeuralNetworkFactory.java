...
public class NeuralNetworkFactory {
	...
	public static void setDefaultIO(NeuralNetwork nnet) {
                Vector<Neuron> inputNeurons = new Vector<Neuron>();
                Layer firstLayer = (Layer) nnet.getLayers().firstElement();
		...
		Vector<Neuron> outputNeurons = ((Layer) nnet.getLayers().lastElement()).getNeurons();
