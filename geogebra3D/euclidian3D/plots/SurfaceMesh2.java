 ...
 * @author André Eriksson
 */
class SurfaceTriList2 extends DynamicMeshTriList2 {
 ...
 * @author André Eriksson
 */
class SurfaceSplitBucketAssigner2 implements BucketAssigner<DynamicMeshElement2> {
 ...
 * @author André Eriksson
 */
class SurfaceMergeBucketAssigner2 implements BucketAssigner<DynamicMeshElement2> {
 ...
 * @author André Eriksson
 */
public class SurfaceMesh2 extends DynamicMesh2 {
	...
	public SurfaceMesh2(SurfaceEvaluable function, double rad,
		...
		for (int i = 0; i < 100; i++)
			split((SurfaceDiamond2) splitQueue.forcePoll());
	}
