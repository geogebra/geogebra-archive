 ...
 *
 */
public class GeoCoordSys2DAbstract extends GeoCoordSysAbstract implements Region3D,
GeoCoordSys2D{
	...
	public GeoCoordSys2DAbstract(Construction c){
		super(c,2);	
	}
	
	public GeoCoordSys2DAbstract(Construction c, GgbVector O, GgbVector V1, GgbVector V2){
		this(c);
		setCoord(O,V1,V2);		
	}

	public GeoCoordSys2DAbstract(Construction c, GeoPoint3D O, GeoPoint3D I, GeoPoint3D J){
		this(c);
		setCoord(O,I,J);		
	}
