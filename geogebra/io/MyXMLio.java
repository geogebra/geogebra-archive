...
//        writeThumbnail(kernel.getConstruction(), zip);
    ...
    public void writeIntergeoFile(OutputStream os) throws IOException {
        ...
        // write construction images
        writeConstructionImages(kernel.getConstruction(), zip, I2G_IMAGES_FOLDER);
    ...
    private void writeConstructionImages(Construction cons, ZipOutputStream zip, String filePath) throws IOException {    	
   	// <-- Modified for Intergeo File Format (Yves Kreis)
...
//    private void writeThumbnail(Construction cons, ZipOutputStream zip) throws IOException {    	
    private void writeThumbnail(Construction cons, ZipOutputStream zip, String fileName) throws IOException {    	
   	// <-- Modified for Intergeo File Format (Yves Kreis)
...
//    			writeImageToZip(zip, XML_FILE_THUMBNAIL, img);
    ...
    private void writeMacroImages(ArrayList macros, ZipOutputStream zip, String filePath) throws IOException {
  	// <-- Modified for Intergeo File Format (Yves Kreis)
    	if (macros == null) return;
