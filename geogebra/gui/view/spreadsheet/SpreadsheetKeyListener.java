...
//			}
		...
		case KeyEvent.VK_DOWN:
			...
			if (table.getSelectedRow() + 1 == table.getRowCount() && table.getSelectedRow() < SpreadsheetView.MAX_ROWS) {
...
//			}
		...
		case KeyEvent.VK_RIGHT:
			...
			if (table.getSelectedColumn() + 1 == table.getColumnCount() && table.getSelectedColumn() < SpreadsheetView.MAX_COLUMNS) {
