 ...
 * on 20/12/10 12:53 from the specification file
 * <tt>matching.jflex</tt>
 */
public final class MatchingBlockScanner {
  ...
  private static final String ZZ_CMAP_PACKED = 
    "\12\1\1\1\2\1\1\1\24\1\1\0\5\1\1\2\1\3\61\1"+
      ...
      zzForAction: {
        while (true) {
          ...
          zzForNext: { switch (zzState) {
            ...
            case 5:
              switch (zzInput) {
                case 0: zzIsFinal = true; zzNoLookAhead = true; zzState = 6; break zzForNext;
                default: zzState = 9; break zzForNext;
              }
