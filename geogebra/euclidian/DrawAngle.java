    ...
    final public void update() {
        ...
        switch (angleDrawMode) {
			...
			default:
				/*
		        if (vertex == null) {
		        	System.err.println(Util.toHTMLString("vertex null for: " + geo + ", parent: " + geo.getParentAlgorithm().getCommandDescription()));		        
		        }*/
				return;
        }
        ...
        if (is90degrees) {			    	        	
			...
			dot90degree.setFrame(coords[0]-geo.lineThickness, 
								 coords[1]-geo.lineThickness,
								 diameter, diameter);
        }
