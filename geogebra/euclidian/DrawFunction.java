 ...
 */
public class DrawFunction extends Drawable {
	
	// TODO: implement new function plotting algorithm
	// avoid multiple evaluation of function for same x when
	// doing backsteps.
	// check discontinuities on the borders
    ...
    public DrawFunction(EuclidianView view, GeoFunction f) {
    	this.view = view;
        this.f = f;
        geo = f;
        update();
