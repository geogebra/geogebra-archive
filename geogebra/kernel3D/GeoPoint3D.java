...
Translateable, PointRotateable, Mirrorable, Dilateable {   	
    ...
    // temp
    public double inhomX, inhomY, inhomZ;
	...
	*/
	...
	final public void setCoords(GeoVec4D v) {
	...
	// TODO
	/*
    final public boolean equals(GeoPoint3D P) {        
    ...
    */
     ...
     * infinty or NaN).            
     */
    final public double distanceSqr(GeoPoint3D P) {          
        double vx = P.inhomX - inhomX;
        double vy = P.inhomY - inhomY;        
        double vz = P.inhomZ - inhomZ;        
    ...
    // TODO
    /*
	public static boolean collinear(GeoPoint3D A, GeoPoint3D B, GeoPoint3D C) {
	...
	*/
     ...
     */
    //TODO
	public static final double det(GeoPoint3D P, GeoPoint3D Q) {		 
	 ...
	 */
	//TODO
	public static final double affineRatio(GeoPoint3D A, GeoPoint3D B, GeoPoint3D C) {		
 ...
 ***********************************************************/
    ...
    */
    ...
    /**
     * TODO rotate this point by angle phi around (0,0)
     */
    ...
    */
    ...
    /**
     * TODO rotate this point by angle phi around Q
     */    
    ...
    */
    ...
    /**
     * TODO mirror this point at point Q
     */
...
/***********************************************************/
	...
	private StringBuffer buildValueString() { 
        ...
        switch (toStringMode) {
            ...
            default: // CARTESIAN                
				...
				sbBuildValueString.append(kernel.format(inhomZ));                                
        }        
		sbBuildValueString.append(')');
		return sbBuildValueString;
    }
	...
	protected void doRemove() {
		if (locateableList != null) {
			...
			for (int i=0; i < locs.length; i++) {		
				...
				//TODO loc.removeStartPoint(this);				
				loc.toGeoElement().updateCascade();			
			}			
		}
	...
	public void setVisualStyle(GeoElement geo) {
		...
		if (geo.isGeoPoint()) {
			//pointSize = ((GeoPoint3D) geo).pointSize;
		}
	}
