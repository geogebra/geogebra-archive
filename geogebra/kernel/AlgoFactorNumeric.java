 ...
 */
public class AlgoFactorNumeric extends AlgoElement {

	private static final long serialVersionUID = 1L;
	private GeoNumeric f; // input
    private GeoNumeric g; // output         
   
    public AlgoFactorNumeric(Construction cons, String label, GeoNumeric f) {
    	super(cons);
        this.f = f;            	
    ...
    protected final void compute() {       
		...
		{
			g.set(kernel.getAlgebraProcessor().evaluateToNumeric(functionOut));			
		}
