 		...
 		case 3:
 			boolean[] ok=new boolean[2];
 			 if((ok[0]=arg[1].isGeoText() && arg[0].isGeoText())
  				...
  				GeoElement[] ret = { 
 						 kernel.IndexOf(c.getLabel(),
 								 (GeoText)arg[0], (GeoText)arg[1],(NumberValue)arg[2] ) };
 				 return ret;
  			 }
 			 else if ((ok[0]=arg[1].isGeoList()) && (ok[1]=arg[2].isNumberValue())) {
				 GeoElement[] ret = { 
						 kernel.IndexOf(c.getLabel(),
								 arg[0], (GeoList)arg[1], (NumberValue)arg[2] ) };
				 return ret;
			 } else
				 if(!ok[0])
					 throw argErr(app, c.getName(), arg[1]);
   	...
   	public CmdPrimeFactorization(Kernel kernel) {
   	 ...
   	 public GeoElement[] process(Command c) throws MyError {
   		 ...
   		 case 1:
   			 ...
   			 if (arg[0].isGeoNumeric()) {
   				 GeoElement[] ret = { 
   						 kernel.PrimeFactorisation(c.getLabel(),
   								 (GeoNumeric)arg[0] ) };
   				 return ret;
   			 } else
 	...
 	public CmdBinomialDist(Kernel kernel) {
 	 ...
 	 public GeoElement[] process(Command c) throws MyError {
 		 ...
 		 case 4:			
 			 ...
 			 {
 				 GeoElement[] ret = { 
 						 kernel.BinomialDist(c.getLabel(),
 								 (NumberValue) arg[0], (NumberValue) arg[1], (NumberValue) arg[2], (GeoBoolean) arg[3] ) };
 				 return ret;
 	...
 	public CmdInverseBinomial(Kernel kernel) {
 	 ...
 	 public GeoElement[] process(Command c) throws MyError {
 		 ...
 		 case 3:			
 			 ...
 			 {
 				 GeoElement[] ret = { 
 						 kernel.InverseBinomial(c.getLabel(),
 								 (NumberValue) arg[0], (NumberValue) arg[1], (NumberValue) arg[2]) };
 				 return ret;
 	...
 	public CmdInversePoisson(Kernel kernel) {
 	 ...
 	 public GeoElement[] process(Command c) throws MyError {
 		 ...
 		 case 2:			
 			 ...
 			 {
 				 GeoElement[] ret = { 
 						 kernel.InversePoisson(c.getLabel(),
 								 (NumberValue) arg[0], (NumberValue) arg[1]) };
 				 return ret;
