...
public class AlgoFrequencyTable extends AlgoElement {
	...
	AlgoFrequencyTable(Construction cons, String label, GeoBoolean isCumulative, GeoList classList, GeoList dataList) {
	...
	AlgoFrequencyTable(Construction cons, String label, GeoBoolean isCumulative, GeoList classList, GeoList dataList, 
		...
		freq = new AlgoFrequency(cons, isCumulative, classList, dataList, useDensity, density);
