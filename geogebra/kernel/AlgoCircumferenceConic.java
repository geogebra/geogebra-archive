...
public class AlgoCircumferenceConic extends AlgoElement {
    ...
    /**
     * Compute circumference. In order to do so we
     * have to distinguishe between the following cases:
     * <pre>
     *   a) conic is a circle
	...
	if (type == GeoConic.CONIC_ELLIPSE) {
