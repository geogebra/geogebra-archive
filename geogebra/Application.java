...
public abstract class Application implements	KeyEventDispatcher {
    ...
    public static final String buildDate = "September 16, 2008";
	
    public static final String versionString = "3.1.39.0";    
...
// GPL2
    ...
    public void openHelp(String command) {
        ...
        try { // convert eg uppersum to UpperSum
         	internalCmd = translateCommand(command);
        ...
        try{   	
        	URL helpURL = getHelpURL(currentLocale, command, internalCmd);
