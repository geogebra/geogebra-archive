...
//    public abstract boolean isProbablePrime(int certainty);
    ...
    public String toMathML() {
        ...
        document.appendChild(new DocumentTypeImpl(document,"math","-//W3C//DTD MathML 2.0//EN","http://www.w3.org/TR/MathML2/dtd/mathml2.dtd"));
        Element e=new ElementImpl(document,"math");
        toMathML(e,null);
        ...
        String s=writer.writeToString(e);
        return s.substring(s.indexOf("\n")+1);
    }

    public abstract void toMathML(Element element, Object data);
    */
}
