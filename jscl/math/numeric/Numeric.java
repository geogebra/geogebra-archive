...
public abstract class Numeric implements Arithmetic, Comparable {
	...
	public Numeric sqrt() {
		return pow(JSCLDouble.valueOf(0.5));
	}
	...
	public Numeric atan() {
		return add(Complex.valueOf(0, 1)).divide(subtract(Complex.valueOf(0, 1))).negate().log().multiply(Complex.valueOf(0, 1)).divide(JSCLDouble.valueOf(2));
	}
	...
	public Numeric atanh() {
		return JSCLDouble.valueOf(1).subtract(this).log().subtract(JSCLDouble.valueOf(1).add(this).log()).divide(JSCLDouble.valueOf(2)).negate();
	}
