   ...
   <xsl:template match="xsd:complexType" mode="properties">
      <table class="properties">
         ...
         <xsl:if test="normalize-space($final)!=''">
            <tr>
               <th>
                  [[Reference:XML Glossary#Prohibited Derivations|Prohibited Derivations]]
               </th>
         ...
         <xsl:if test="normalize-space($block)!=''">
            <tr>
               <th>
                  [[Reference:XML Glossary#Prohibited Substitutions|Prohibited Substitutions]]
               </th>
   ...
   <xsl:template match="xsd:element" mode="properties">
      <table class="properties">
         ...
         <xsl:if test="normalize-space($final)!=''">
            <tr>
               <th>
                  [[Reference:XML Glossary#Substitution Group Exclusions|Substitution Group Exclusions]]
               </th>
         ...
         <xsl:if test="normalize-space($block)!=''">
            <tr>
               <th>
                  [[Reference:XML Glossary#Prohibited Substitutions|Prohibited Derivations]]
               </th>
               <td><xsl:value-of select="$block"/></td>
            </tr>
         </xsl:if>
